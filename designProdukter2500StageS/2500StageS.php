...
<head>
    ...
    <title>Tilpasning af 2500 Stage S</title>
</head>
<body>
    <H1>Tilpasning af 2500 Stage S</H1>
    <form method="post">
        ...
        <h2>Indhold af din kurv</h2>
            ...
            <H4>
                ...
                <?php
                    ...
                    function bekræftKøb() {
                        echo "Tak for dit køb af 2500 Stage S. Vi sender varen inden for 3-5 hverdage. Den endelige pris blev: 4.370 Kr.";
                    }
                ?>
            </H4>
    </div>
