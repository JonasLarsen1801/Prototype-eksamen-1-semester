...
<head>
    ...
    <title>Tilpasning af Nobel 8900</title>
</head>
<body>
    <H1>Tilpasning af Nobel 8900</H1>
    <form method="post">
        ...
        <h2>Indhold af din kurv</h2>
            ...
            <H4>
                ...
                <?php
                    ...
                    function bekræftKøb() {
                        echo "Tak for dit køb af Nobel 8900. Vi sender varen inden for 3-5 hverdage. Den endelige pris blev: 14.955 Kr.";
                    }
                ?>
            </H4>
    </div>
